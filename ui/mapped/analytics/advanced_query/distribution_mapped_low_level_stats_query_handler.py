...
def _execute_and_display_query(st_app, data_path: str, stats_path: str, 
    ...
    try:
        ...
        # Mostra warning se risultati potrebbero essere truncati
        if len(result_df) == DISPLAY_LIMIT:
            st_app.warning(f"⚠️ Visualizzazione limitata a {DISPLAY_LIMIT} righe per performance. Tutti i dati verranno salvati al download.")
